...
public class AppConstants {
	...
	public final static String LOGIN_PAGE_URL_FRACTION = "naveenautomationlabs.com/opencart";
	...
	public final static String CONFIG_PROP_FILE_PATH = "./src/test/resources/config/config.properties";
